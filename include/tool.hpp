...
namespace tool {
    ...
    /**
     * @brief Encapsulates all the structure needed for a command line tool.
     *
    ...
    class Tool {
        public:
            ...
            Tool(const std::string& name, const std::string& description, bool operands_reqd = true, std::ostream& os = std::cerr );
        ...
        protected:  
            // need visibility of these in child classes implementing the () method.
        ...
        private:
            ...
            std::vector<option> option_vector_;
            std::string name_;
